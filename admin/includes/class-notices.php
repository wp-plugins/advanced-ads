...
class AdvAds_Admin_Notices {
    ...
    public function __construct($old_version = 0, $new_version = 0, $updated_versions = array()){
        ...
        $this->update_notices = array(
            '1.4.5' => 'Advanced Ads 1.4.5 changes the behavior of some display conditions. Please read this <a href="http://wpadvancedads.com/advanced-ads-1-4-5/" target="_blank">update post</a> to learn if this change should concern you.',
        );
